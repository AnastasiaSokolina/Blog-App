...
export const editArticleFetch = createAsyncThunk('editArticleSlice/editArticle', async (action) => {
  const {
    editProfileShortDescription, editProfileText, editProfileTitle, tags, token, params,
  } = action;
  const body = {
    article: {
